	...
	return (
		...
		>
			...
			<button
				...
				className="min-h-11 min-w-[120px] rounded-lg bg-accent px-8 py-3 text-base font-semibold text-on-primary transition-all duration-200 hover:bg-accent-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-focus focus-visible:ring-offset-2 focus-visible:ring-offset-primary active:scale-[0.98] md:text-lg"
			>
				문의하기
			</button>
		</section>
